/**
 * Source: https://github.com/sirikata/liboauthcpp/
 */
                                          ...
                                          const bool generateTimestamp )
{
    ...
    ReplaceOrInsertKeyValuePair(keyValueMap, Defaults::SIGNATUREMETHOD_KEY, std::string( "PLAINTEXT" ));
                          ...
                          std::string& oAuthSignature )
{
    ...
    /* Do an url encode */
     oAuthSignature = secretSigningKey;
    ...
    const bool includeOAuthVerifierPin)
{
    ...
    buildOAuthTokenKeyValuePairs( includeOAuthVerifierPin, rawData, std::string( "" ), rawKeyValuePairs, false, true );
